...
void onInitialization( ) {
	...
	float SunPosition[] = {-5.0f, -30.0f, -1.0f, 0.0};			//NAP: 4. koord 0.0 -> pozicioja vegtelen tavol, ettol iranyfenyforras
	...
	glViewport(0, 0, w_width, w_height);						//kepernyo transzf
		...
		shadow[1][0] = 0.0f; shadow[1][1] = 1.0f; shadow[1][2] = 0.0f; shadow[1][3] = 0.0f;
		shadow[2][0] = -(SunPosition[0])/(SunPosition[1]); shadow[2][1] = -(SunPosition[2])/(SunPosition[1]); shadow[2][2] = 0.0f; shadow[2][3] = 0.0f;
		shadow[3][0] = 0.0f; shadow[3][1] =  EPSILON; /*EPS*/shadow[3][2] = 0.0f; shadow[3][3] = 1.0f;
...
int main(int argc, char **argv) {
	...
	glutInitWindowSize(w_width, w_height);			// Alkalmazas ablak kezdeti merete 600x600 pixel 
	...
	glDeleteTextures(1,&g_textureId[0]);
	glDeleteTextures(1,&g_textureId[1]);
